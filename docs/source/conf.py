...
html_baseurl = 'https://sbd1.github.io/2025.1-Minecraft/'

# -- Options for autodoc -----------------------------------------------------

# Automatically extract typehints when specified and place them in
# descriptions of the relevant functions/methods.
autodoc_typehints = 'description'

# Don't show type hints in the description
autodoc_typehints_description_target = 'documented'

# Mock imports for modules that might not be available during documentation build
autodoc_mock_imports = ['psycopg2', 'colorama']
